...
SELECT m.dept_no department_number, d.dept_name department_name, e.emp_no manager_employee_number, e.last_name manager_last_name, e.first_name manager_first_name
	FROM dept_manager m
...
SELECT de.dept_no department_number, e.emp_no employee_number, e.last_name, e.first_name, d.dept_name department_name
	FROM employees e
